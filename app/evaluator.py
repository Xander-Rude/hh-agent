...
- не усиливай исходный черновик за счёт лишних достижений и не делай кандидата "идеальнее";
- сохрани нюансы исходной оценки: если роль смежная, не маскируй этот gap;
...
- Главная цель письма — коротко объяснить релевантность, а не доказать, что кандидат идеален.
- Не маскируй gaps и не компенсируй их набором самых крупных достижений из резюме.
  Если вакансия смежная с основным профилем кандидата, честно обозначь основной профиль
  и покажи 1-2 переносимых компетенции без попытки выдать смежный опыт за прямой.
- Не собирай в одном письме "пулемётную очередь" из масштаба: портфель 30+ проектов,
  команды до 70 человек, найм 40+, крупный бюджет, C-level/CEO-1. Используй максимум
  один такой масштабный факт и только когда он прямо помогает ответить на требования вакансии.
- Для решения review особенно важно сохранить нюанс оценки: письмо не должно звучать
  сильнее, чем выводы strengths/gaps и сам match-анализ.
...
- {ai_project_cover_rule}
- Выбери 1-2 наиболее релевантных факта/результата. Третий добавляй только если без него теряется важный контекст вакансии.
